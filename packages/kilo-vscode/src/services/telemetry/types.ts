...
export enum TelemetryEventName {
  ...
  AGENT_MANAGER_ACTION = "Agent Manager Action",
  AGENT_MANAGER_STATE_SNAPSHOT = "Agent Manager State Snapshot",
  ...
  DIFF_VIEWER_OPENED = "Diff Viewer Opened",
  REVIEW_COMMENT_ACTION = "Review Comment Action",
