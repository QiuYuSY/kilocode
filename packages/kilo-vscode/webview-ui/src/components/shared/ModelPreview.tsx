    ...
    <div class="model-preview">
      <Show when={m()}>
        {(model) => {
          ...
          const starred = () =>
            session
              ? session.favoriteModels().some((f) => f.providerID === model().providerID && f.modelID === model().id)
              : false
                ...
                <div class="model-preview-name-row">
                  ...
                  <Show when={session}>
                    <button
                      ...
                      aria-label={starred() ? language.t("model.favorite.remove") : language.t("model.favorite.add")}
